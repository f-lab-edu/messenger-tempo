...
public class JdbcMemberRepository implements MemberRepository {
    ...
    public boolean save(Member member) {
        ...
        try {
            ...
            log.debug("[save] executeUpdate return: {}", ret);
            if (ret != 1) {
    ...
    public boolean updatePassword(String id, String password) {
        ...
        try {
            ...
            int ret = pstmt.executeUpdate();
            log.debug("[updatePassword] executeUpdate return: {}", ret);
            conn.commit();  // 트랜잭션 커밋
            return true;
        } catch (Exception e) {
            if (conn != null) {
    ...
    public boolean updateDisplayName(String id, String name) {
        ...
        try {
            ...
            pstmt.setString(2, id);
            int ret = pstmt.executeUpdate();
            log.debug("[updateDisplayName] executeUpdate return: {}", ret);
            conn.commit();  // 트랜잭션 커밋
            return true;
        } catch (Exception e) {
            if (conn != null) {
    ...
    public boolean updateContent(String id, String content) {
        ...
        try {
            ...
            pstmt.setString(2, id);
            int ret = pstmt.executeUpdate();
            log.debug("[updateContent] executeUpdate return: {}", ret);
            conn.commit();  // 트랜잭션 커밋
            return true;
        } catch (Exception e) {
            if (conn != null) {
